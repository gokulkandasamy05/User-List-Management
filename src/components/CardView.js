...
import { Avatar, Card, Col, Pagination, Popconfirm, Row, Space } from 'antd'

const CardView = ({ dataSource }) => {
                        ...
                        >
                            ...
                            >
                                ...
                                <div className='card__view--card-actions'>
                                    <Space>
                                        <EditOutlined className='icons-edit' />
                                        <Popconfirm title="Sure to delete?" onConfirm={() => handleDelete(item.key)}>
